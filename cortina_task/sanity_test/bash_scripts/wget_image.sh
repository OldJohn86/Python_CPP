...
cd $WORK_DIR
rm *.bin  *g3* *saturn* *uImage*


#get G3 major-images
wget http://192.168.65.235:18683/g3/$MonTimeTag/$DayTimeTag/$G3_ImageType/major-image-g3-eng-gpt-nandinfo.img
cp major-image-g3-eng-gpt-nandinfo.img $WORK_DIR/$MonTimeTag/$DayTimeTag/g3_images/
...
wget http://192.168.65.235:18683/g3/$MonTimeTag/$DayTimeTag/$G3_ImageType/major-image-g3-eng.mubi
cp major-image-g3-eng.mubi $WORK_DIR/$MonTimeTag/$DayTimeTag/g3_images/
...
wget http://192.168.65.235:18683/saturn-sfu/$MonTimeTag/$DayTimeTag/$Saturn_sfu_epon_ImageType/major-image-saturn-sfu-eng-gpt.img
cp major-image-saturn-sfu-eng-gpt.img $WORK_DIR/$MonTimeTag/$DayTimeTag/saturn_sfu_epon_images/
...
wget http://192.168.65.235:18683/saturn-sfu/$MonTimeTag/$DayTimeTag/$Saturn_sfu_epon_ImageType/uImage-saturn_sfu.dtb
cp uImage-saturn_sfu.dtb $WORK_DIR/$MonTimeTag/$DayTimeTag/saturn_sfu_epon_images/
...
wget http://192.168.65.235:18683/saturn-sfu/$MonTimeTag/$DayTimeTag/$Saturn_sfu_epon_ImageType/major-image-saturn-sfu-eng.rootfs.squashfs.ubi
cp major-image-saturn-sfu-eng.rootfs.squashfs.ubi $WORK_DIR/$MonTimeTag/$DayTimeTag/saturn_sfu_epon_images/

wget http://192.168.65.235:18683/saturn-sfu/$MonTimeTag/$DayTimeTag/$Saturn_sfu_epon_ImageType/major-image-saturn-sfu-eng_user.ubi
cp major-image-saturn-sfu-eng_user.ubi $WORK_DIR/$MonTimeTag/$DayTimeTag/saturn_sfu_epon_images/
