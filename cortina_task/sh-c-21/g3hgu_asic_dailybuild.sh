...
WORK_DIR=/space/pchen/Saturn_HGU/
...
#fi
cd $WORK_DIR
#cp $BUILD_DIR-$DayTimeTag/build/tmp/deploy/images/g3hgu-eng/Image $MonTimeTag/$DayTimeTag
#cp $BUILD_DIR-$DayTimeTag/build/tmp/deploy/images/g3hgu-eng/Image-ca8279-engboard.dtb $MonTimeTag/$DayTimeTag
#cp $BUILD_DIR-$DayTimeTag/build/tmp/deploy/images/g3hgu-eng/major-image-g3hgu-eng.cpio.xz  $MonTimeTag/$DayTimeTag
#cp $BUILD_DIR-$DayTimeTag/build/tmp/deploy/images/g3hgu-eng/u-boot.bin $MonTimeTag/$DayTimeTag
#cp $BUILD_DIR-$DayTimeTag/build/tmp/deploy/images/g3hgu-eng/major-image-g3hgu-eng.ubi $MonTimeTag/$DayTimeTag
