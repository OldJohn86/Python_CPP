...
git clone -b kt-krogoth-20181211 gitolite@cs-local-gitmirror:sw/platforms/cs-unified/distro/yocto $BUILD_DIR-$TimeTag
...
export TEMPLATECONF=meta-oe-ca/conf/saturn-sfu-eng-kt
