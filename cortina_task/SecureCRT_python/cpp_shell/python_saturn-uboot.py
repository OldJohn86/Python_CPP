...
def main():
	...
	# # Upgrade kernel
	# if crt.Screen.WaitForStrings("Written: OK") == 1:
		# crt.Screen.Send("tftpboot 0x85100000 saturn_sfu_eng_epon-uImage;")
	...
	# # Upgrade dtb
	# if crt.Screen.WaitForStrings("Written: OK") == 1:
		# crt.Screen.Send("tftpboot 0x85000000 saturn_sfu_eng_epon.dtb;")
	...
	# # Upgrade rootfs
	# if crt.Screen.WaitForStrings("Written: OK") == 1:
		# crt.Screen.Send("tftpboot 0x86000000 saturn_sfu_eng_epon-rootfs.cpio.xz;")
