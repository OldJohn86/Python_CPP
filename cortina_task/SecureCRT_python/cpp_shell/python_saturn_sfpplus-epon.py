...
def main():
	...
	if crt.Screen.WaitForStrings("SATURN#") == 1:
		crt.Screen.Send("tftpboot 0x84100000 saturn_sfpplus_eng-gpt.img;")
	...
	if crt.Screen.WaitForStrings("Written: OK") == 1:
		crt.Screen.Send("tftpboot 0x84000000 saturn_sfpplus_eng-uboot-env.bin;")
	...
	# Upgrade kernel
	if crt.Screen.WaitForStrings("Written: OK") == 1:
		crt.Screen.Send("tftpboot 0x85100000 saturn_sfpplus_eng-uImage;")
	...
	# Upgrade dtb
	if crt.Screen.WaitForStrings("Written: OK") == 1:
		crt.Screen.Send("tftpboot 0x85000000 saturn_sfpplus_eng.dtb;")
	...
	# Upgrade rootfs
	if crt.Screen.WaitForStrings("Written: OK") == 1:
		crt.Screen.Send("tftpboot 0x86000000 saturn_sfpplus_eng-rootfs.cpio.xz;")
	...
	# Upgrade user.ubi
	if crt.Screen.WaitForStrings("Written: OK") == 1:
		crt.Screen.Send("tftpboot 0x87000000 saturn_sfpplus_eng-user.ubi;")
