...
def main():
	...
	if crt.Screen.WaitForStrings("SATURN#") == 1:
		crt.Screen.Send("tftpboot 0x84100000 saturn_sfu_eng_gpon-gpt.img;")
	...
	if crt.Screen.WaitForStrings("Written: OK") == 1:
		crt.Screen.Send("tftpboot 0x84000000 saturn_sfu_eng_gpon-uboot-env.bin;")
	...
	# Upgrade kernel
	if crt.Screen.WaitForStrings("Written: OK") == 1:
		crt.Screen.Send("tftpboot 0x85100000 saturn_sfu_eng_gpon-uImage;")
	...
	# Upgrade dtb
	if crt.Screen.WaitForStrings("Written: OK") == 1:
		crt.Screen.Send("tftpboot 0x85000000 saturn_sfu_eng_gpon.dtb;")
	...
	# Upgrade rootfs
	if crt.Screen.WaitForStrings("Written: OK") == 1:
		crt.Screen.Send("tftpboot 0x86000000 saturn_sfu_eng_gpon-rootfs.cpio.xz;")
	...
	# Upgrade user.ubi
	if crt.Screen.WaitForStrings("Written: OK") == 1:
		crt.Screen.Send("tftpboot 0x87000000 saturn_sfu_eng_gpon-user.ubi;")
