...
typedef struct {
    ...
    oam_uint32          instance_num;
    oam_uint16          alarm_id;
    oam_uint16          time_stamp;
    oam_uint8           alarm_state;
    oam_uint8           alarm_info[8];       /*4 byte or 8 byte*/
...
typedef struct {
    oam_var_cont_t      hdr;
    oam_uint8           ip_addr[16];
    oam_uint8           ip_mask[4];
    oam_uint8           gateway[16];
    oam_uint16          cvlan;
    oam_uint16          svlan;
    oam_uint8           priority;
...
typedef struct {
    ...
    oam_uint8           version;
    oam_uint32          trap_ip;
    oam_uint16          trap_port;
    oam_uint16          snmp_port;
    oam_uint8           name[32];
    oam_uint8           com_rd[32];
    oam_uint8           com_wr[32];
...
typedef struct {
    oam_var_cont_t      hdr;
    oam_uint8           sipDigBlockNum;
    oam_uint8           digMapId;
    oam_uint8           digitBlock[1024];
...
typedef struct {
    oam_var_cont_t      hdr;
    oam_uint32          port_status;
    oam_uint32          port_service_state;
    oam_uint32          port_codec_mode;
} __attribute__((packed)) oam_ctc_onu_pots_status_t;


typedef struct {
    oam_var_cont_t      hdr;
    oam_uint32          oper_status;
} __attribute__((packed)) oam_ctc_onu_h248_iad_t;

typedef struct {
    oam_var_cont_t      hdr;
    oam_uint8           voice_t38_enable;
    oam_uint8           voice_control;
} __attribute__((packed)) oam_ctc_onu_fax_modem_config_t;

typedef struct {
    oam_var_cont_t      hdr;
    oam_uint8           user_account[16];
    oam_uint8           user_name[32];
    oam_uint8           user_passwd[16];
} __attribute__((packed)) oam_ctc_onu_sip_user_config_t;


typedef struct {
    oam_var_cont_t      hdr;
    oam_uint16          mg_port_no;
    oam_uint32          proxy_srv_ip;
    oam_uint16          proxy_srv_port;
    oam_uint32          backup_proxy_srv_ip;
    oam_uint16          backup_proxy_srv_port;
    oam_uint32          active_proxy_srv;
    oam_uint32          reg_srv_ip;
    oam_uint16          reg_srv_port;
    oam_uint32          backup_reg_srv_ip;
    oam_uint16          backup_reg_srv_port;
    oam_uint32          outbound_srv_ip;
    oam_uint16          outbound_srv_port;
    oam_uint32          reg_interval;
    oam_uint8           heartbeat_switch;
    oam_uint16          heartbeat_cycle;
    oam_uint16          heartbeat_count;
} __attribute__((packed)) oam_ctc_onu_sip_param_config_t;

typedef struct {
    oam_var_cont_t      hdr;
    oam_uint8           number_of_tid;
    oam_uint8           first_tid_name[32];
} __attribute__((packed)) oam_ctc_onu_h248_rtp_tid_info_t;

typedef struct {
    oam_var_cont_t      hdr;
    oam_uint8           number_of_tid;
    oam_uint8           tid_prefix[16];
    oam_uint8           tid_digit_begin[8];
    oam_uint8           tid_mode;
    oam_uint8           tid_digit_len;
} __attribute__((packed)) oam_ctc_onu_h248_rtp_tid_info_config_t;

typedef struct {
    oam_var_cont_t      hdr;
    oam_uint8           user_tid_name[32];
...
typedef struct {
    ...
    oam_uint32          mgc_ip;
    oam_uint16          mgc_port;
    oam_uint32          backup_mgc_ip;
    oam_uint16          backup_mgc_port;
    oam_uint8           active_mgc;
    oam_uint8           reg_mode;
    oam_uint8           mid[64];
    oam_uint8           heartbeat_mode;
    oam_uint16          heartbeat_cycle;
    oam_uint8           heartbeat_count;
...
typedef struct {
    ...
    oam_uint8           voip_mode;
    oam_uint32          iad_ip;
    oam_uint32          iad_ip_mask;
    oam_uint32          iad_default_gw;
    oam_uint8           ppoe_mode;
    oam_uint8           ppoe_username[32];
    oam_uint8           ppoe_passwd[32];
    oam_uint8           tagged_flag;
    oam_uint16          voice_cvlan;
    oam_uint16          voice_svlan;
    oam_uint8           voice_priority;
} __attribute__((packed)) oam_ctc_onu_voip_global_param_config_t;

typedef struct {
    oam_var_cont_t      hdr;
    oam_uint8           mac[6];
    oam_uint8           protocol_support;
    oam_uint8           software_ver[32];
    oam_uint8           software_time[32];
    oam_uint8           voip_user_count;
} __attribute__((packed)) oam_ctc_onu_voip_iad_info_t;
*/

typedef struct {
    oam_uint8           queue_num;
    oam_uint16          fixed_packet_size;
    oam_uint16          fixed_bandwidth;
    oam_uint16          guaranteed_bandwidth;
    oam_uint16          best_effort_bandwith;
    oam_uint8           wrr_weigth;
...
#define OAM_CTC_VENDOR_ID_LEN               4
...
typedef struct {
    oam_var_cont_t      hdr;
    oam_uint8           venderId[OAM_CTC_VENDOR_ID_LEN];
    oam_uint8           model[OAM_CTC_MODEL_ID_LEN];
    oam_uint8           onuId[OAM_CTC_ONU_ID_LEN];
    oam_uint8           hwVer[OAM_CTC_ONU_HW_LEN];
    oam_uint8           swVer[OAM_CTC_ONU_SW_LEN];
    oam_uint8           extend_model[OAM_CTC_EXTEND_MODEL_ID];
...
typedef struct {
    oam_var_cont_t      hdr;
    oam_uint8           fwVersion[OAM_CTC_ONU_FW_VERSION_LEN];
...
typedef struct {
    oam_var_cont_t  hdr;
    oam_uint8       venderId[OAM_CTC_ONU_CHIPID_MODEL_LEN];
    oam_uint8       chipModel[OAM_CTC_ONU_CHIPID_MODEL_LEN];
    oam_uint8       Revision;
    oam_uint8       Date[OAM_CTC_ONU_CHIPID_DATE_LEN];
...
typedef struct {
    oam_var_cont_t  hdr;
    oam_uint8       serviceSupported;
    oam_uint8       numGEPorts;
    oam_uint64      geBitMap;
    oam_uint8       numFEPorts;
    oam_uint64      feBitMap;
    oam_uint8       numPOTSPorts;
    oam_uint8       numE1Ports;
    oam_uint8       numUSQueues;
    oam_uint8       maxQueueUSPort;
    oam_uint8       numDSQueues;
    oam_uint8       maxQueueDSPort;
    oam_uint8       BatteryBackup;
...
#define CTC_OAM_MAX_INTF_NUM    16

typedef struct {
    oam_uint32      interfaceType;
    oam_uint16      numPorts;
...
typedef struct {
    ...
    oam_uint32              onuType;
    oam_uint8               multillid;
    oam_uint8               protectionType;
    oam_uint8               numPONIf;
    oam_uint8               numSlot;
    oam_uint8               numInterface;
    oam_ctc_onu_interface_t intf[CTC_OAM_MAX_INTF_NUM];
    oam_uint8               BatteryBackup;
...
typedef struct {
    oam_var_cont_t  hdr;
    oam_uint8       ipv6Support;
    oam_uint8       powerControl;
    oam_uint8       serviceSla;
...
typedef struct {
    ...
    oam_uint8       max_sleep_duration[CTC_OAM_DURATION_MAX_LEN];
} __attribute__((packed)) oam_ctc_onu_power_saving_config_t;

typedef struct {
    oam_var_cont_t  hdr;
    oam_uint16      los_optical_time;
    oam_uint16      los_mpcp_time;
...
typedef struct {
    oam_var_cont_t  hdr;
    oam_uint8       portOper;
    oam_uint8       portCIR[CTC_PORT_CIR_LEN];
    oam_uint8       portCBS[CTC_PORT_CBS_LEN];
    oam_uint8       portEBS[CTC_PORT_EBS_LEN];
...
typedef struct {
    ...
    oam_uint8       portOper;
    oam_uint8       portCIR[CTC_PORT_CIR_LEN];
    oam_uint8       portPIR[CTC_PORT_PIR_LEN];
...
typedef enum {
    CTC_VLAN_MODE_TRANSPARENT = 0,
    CTC_VLAN_MODE_TAG,
    CTC_VLAN_MODE_TRANSLATE,
    CTC_VLAN_MODE_AGG,
    CTC_VLAN_MODE_TRUNK,
    CTC_VLAN_MODE_MAX
} oam_ctc_vlan_mode_t;
...
#define CTC_CLASS_VALIDATION_OPER_NEVER         0
...
typedef struct {
    oam_uint8       fieldSelect;
    oam_uint8       matchValue[CTC_CLASS_MATCH_VAL_LEN];
    oam_uint8       validationOper;
} __attribute__((packed)) oam_ctc_onu_class_fselect_t;

typedef struct {
    oam_uint8       fieldSelect;
    oam_uint8       matchValue[OAM_IPV6_ADDR_LEN];
    oam_uint8       validationOper;
...
typedef struct {
    oam_var_cont_t  hdr;
    oam_uint8       vlanOper;
    oam_uint16      vlanIds[CTC_MC_VLAN_MAX];
...
typedef struct {
    oam_uint16      userId;
    oam_uint16      vlanId;
    oam_uint8       mc_da[OAM_MACADDR_LEN];
...
typedef struct {
    oam_uint16      userId;
    oam_uint8       mc_da[OAM_MACADDR_LEN];
    oam_uint8       ip_addr[OAM_IPV6_ADDR_LEN];
...
typedef struct {
    oam_uint64      dn_drop_events;
    oam_uint64      up_drop_events;
    oam_uint64      dn_octets;
    oam_uint64      up_octets;
    oam_uint64      dn_frames;
    oam_uint64      up_frames;
    oam_uint64      dn_bc_frames;
    oam_uint64      up_bc_frames;
    oam_uint64      dn_mc_frames;
    oam_uint64      up_mc_frames;
    oam_uint64      dn_crc_err_frames;
    oam_uint64      up_crc_err_frames;
    oam_uint64      dn_undersize_frames;
    oam_uint64      up_undersize_frames;
    oam_uint64      dn_oversize_frames;
    oam_uint64      up_oversize_frames;
} __attribute__((packed)) oam_ctc_onu_port_stats_frag1_t;

typedef struct {
    oam_uint64      dn_fragments;
    oam_uint64      up_fragments;
    oam_uint64      dn_jabbers;
    oam_uint64      up_jabbers;

    oam_uint64      dn_64_octets_frames;
    oam_uint64      dn_65_127_octets_frames;
    oam_uint64      dn_128_255_octets_frames;
    oam_uint64      dn_256_511_octets_frames;
    oam_uint64      dn_512_1023_octets_frames;
    oam_uint64      dn_1024_1518_octets_frames;
    oam_uint64      up_64_octets_frames;
    oam_uint64      up_65_127_octets_frames;
    oam_uint64      up_128_255_octets_frames;
    oam_uint64      up_256_511_octets_frames;
    oam_uint64      up_512_1023_octets_frames;
    oam_uint64      up_1024_1518_octets_frames;
} __attribute__((packed)) oam_ctc_onu_port_stats_frag2_t;


typedef struct {
    oam_uint64      dn_discard_frames;
    oam_uint64      up_discard_frames;
    oam_uint64      dn_err_frames;
    oam_uint64      up_err_frames;
    oam_uint64      status_change_times;
...
typedef struct {
    oam_var_cont_t  hdr;
    oam_uint32      llid_num;
} __attribute__((packed)) oam_ctc_onu_multi_llid_admin_ctrl_t;
...
typedef struct {
    oam_uint8       reportBitmap;
    oam_uint16      queueThreshold[CTC_ONU_MAX_QUEUE];
} __attribute__((packed)) oam_ctc_onu_dba_queue_set_t;

typedef struct {
    oam_uint8                       numQueueSet;
...
typedef struct {
    oam_uint8       churningCode;
    oam_uint8       inUserKeyIdx;
} __attribute__((packed)) oam_ctc_onu_new_key_req_t;


#define CHURNING_KEY_LEN                        3
#define CHURNING_KEY_10G_LEN                    9

typedef struct {
    oam_uint8       churningCode;
    oam_uint8       inUserKeyIdx;
    oam_uint8       churningKey[CHURNING_KEY_10G_LEN];
...
#define COMMIT_RSP_ACK_OK          0
#define COMMIT_RSP_ACK_PARA_ERROR  1
#define COMMIT_RSP_ACK_NOT_SUPP    2
#define COMMIT_RSP_ACK_ERROR       3
...
typedef struct {
    ...
    oam_uint16      tid;
    oam_uint16      opcode;
} __attribute__((packed)) oam_ctc_swimg_hdr_t;

typedef struct {
    oam_ctc_swimg_hdr_t hdr;
    oam_uint16          block;
    oam_uint8           data[1];
} __attribute__((packed)) oam_ctc_swimg_data_t;

typedef struct {
    oam_ctc_swimg_hdr_t hdr;
    oam_uint16          block;
} __attribute__((packed)) oam_ctc_swimg_ack_t;


typedef struct {
    oam_ctc_swimg_hdr_t hdr;
    oam_uint8          data;
} __attribute__((packed)) oam_ctc_swimg_cmn_t;


typedef struct {
    oam_ctc_swimg_hdr_t hdr;
    oam_uint32      size;
} __attribute__((packed)) oam_ctc_swimg_end_t;

typedef struct {
    oam_ctc_swimg_hdr_t hdr;
    oam_uint16          error;
    oam_uint8           errmsg[1];
} __attribute__((packed)) oam_ctc_swimg_err_t;
...
typedef struct {
    ...
    union {
        oam_uint8   data[CTC_AUTH_LOID_LEN + CTC_AUTH_PSWD_LEN];
        struct {
            oam_uint8       loid[CTC_AUTH_LOID_LEN];
            oam_uint8       pswd[CTC_AUTH_PSWD_LEN];
        } s;
    } u;
...
typedef struct {
    oam_uint8       subtype;
    oam_uint16      entry_count;
    oam_uint8       event_data[1];
} __attribute__((packed)) oam_ctc_event_hdr_t;

typedef struct {
    oam_uint16      object_type;
    oam_uint32      object_inst;
    oam_uint16      id;
