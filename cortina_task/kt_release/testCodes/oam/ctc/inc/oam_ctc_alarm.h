...
****************************************************************************/
#ifndef _OAM_CTC_ALARM_H_
#define _OAM_CTC_ALARM_H_
...
typedef struct {
    ...
    oam_uint8       threshold_type;
    oam_boolean     info_need;
    oam_boolean     polling_need;
    oam_uint8       alarm_state;   /*raise or clear*/
    oam_uint8       enable;           /*alarm on or alarm off*/
    union {
        oam_uint32  unsignValue;
        oam_int32   signValue;
...
typedef struct {
    ...
    oam_uint32 msg_info; /* ###### */
#endif
    oam_uint32      polling_enable_counter;
    oam_uint32      timer_handler;
    oam_uint32      timer_value;
