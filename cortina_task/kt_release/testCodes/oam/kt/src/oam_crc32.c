...
/* ====================================================================== */
#include "oam_cmn.h"
static const oam_uint32 crc32_tab[] = {
...
/* This is the standard Gary S. Brown's 32 bit CRC algorithm, but
   accumulate the CRC into the result of a previous CRC. */
    oam_uint32
oam_crc32_accumulate(oam_uint32 crc32val, unsigned char *s, int len)
{
    int i;
...
/* This is the standard Gary S. Brown's 32 bit CRC algorithm */
    oam_uint32
oam_crc32(unsigned char *s, int len)
{
    return (oam_crc32_accumulate(0,s,len));
}
