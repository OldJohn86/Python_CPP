...
typedef oam_uint8               oam_oui_t[OAM_OUI_LEN];
...
typedef oam_uint32 (* oam_vendor_build_handler_t)(
    oam_llid_t llid,
    oam_uint8 *frame,
    oam_uint32 length);
...
typedef struct {
    oam_uint8               code;  /*code = 0 is invalid*/
